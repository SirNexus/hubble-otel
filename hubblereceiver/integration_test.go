...
import (
	...
	"github.com/cilium/hubble-otel/hubblereceiver"
...
func TestIntegration(t *testing.T) {
	...
	go testutil.RunOpenTelemtryCollector(ctx, t, "testdata/collector-with-tls.yaml", fatal, hubblereceiver.NewFactory())
