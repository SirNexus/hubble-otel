...
func (r *hubbleReceiver) Start(_ context.Context, host component.Host) error {
	...
	var err error
	r.hubbleConn, err = r.cfg.GRPCClientSettings.ToClientConn(r.ctx, host, componenttest.NewNopTelemetrySettings())
	if err != nil {
...
func (r *hubbleTraceReceiver) run(
	ctx context.Context,
	log *logrus.Logger,
	hubbleConn *grpc.ClientConn,
	cfg *Config,
